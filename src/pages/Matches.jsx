    ...
    >
      ...
      >
        <div style={{ textAlign: "center", flex: 1 }}>
          <img
            src={`https://flagsapi.com/${match.code_home}/flat/64.png`}
            alt={match.home}
            style={{
              width: "64px",
              height: "64px",
        ...
        <div style={{ textAlign: "center", flex: 1 }}>
          <img
            src={`https://flagsapi.com/${match.code_away}/flat/64.png`}
            alt={match.away}
            style={{
              width: "64px",
              height: "64px",
      ...
      {submitted && (
        ...
        >
          ...
          <p
            style={{ color: "#4ade80", fontSize: "1.4rem", fontWeight: "700" }}
          >
            {homeScore} — {awayScore}
          </p>
        </div>
  ...
  useEffect(() => {
    getMatches().then((data) => {
      ...
      for (let i = 0; i < days.length; i++) {
        ...
        const hasUpcoming = dayMatches.some(
    ...
    <div style={{ minHeight: "100vh" }}>
      ...
      >
        ...
        {!loading && matchdays.length > 0 && (
          ...
          >
            <button
              onClick={() => setCurrentMatchday((d) => Math.max(0, d - 1))}
              disabled={currentMatchday === 0}
              style={{
                background: "transparent",
                color: currentMatchday === 0 ? "#333" : "#fff",
                border: "none",
                cursor: currentMatchday === 0 ? "not-allowed" : "pointer",
                fontSize: "1.2rem",
              }}
            >
              ←
            ...
            <button
              onClick={() =>
                setCurrentMatchday((d) => Math.min(matchdays.length - 1, d + 1))
              }
              disabled={currentMatchday === matchdays.length - 1}
              style={{
                background: "transparent",
                color:
                  currentMatchday === matchdays.length - 1 ? "#333" : "#fff",
                border: "none",
                cursor:
                  currentMatchday === matchdays.length - 1
                    ? "not-allowed"
                    : "pointer",
                fontSize: "1.2rem",
              }}
